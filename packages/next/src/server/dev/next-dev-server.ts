...
import type { DevService } from '../lib/dev-service'
...
export default class DevServer extends Server {
  ...
  constructor(options: Options) {
    ...
    this.devService = options.devService
  ...
  protected async logErrorWithOriginalStack(
    ...
    await this.devService.logErrorWithOriginalStack(err, type)
  }
  ...
  protected async ensurePage(opts: {
    ...
    await this.devService.ensurePage(opts)
  }
  ...
  protected async getFallbackErrorComponents(): Promise<LoadComponentsReturnType | null> {
    await this.devService.getFallbackErrorComponents()
    return await loadDefaultErrorComponents(this.distDir)
  }

  async getCompilationError(page: string): Promise<any> {
    return await this.devService.getCompilationError(page)
  }
}
